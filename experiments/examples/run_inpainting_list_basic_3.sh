...
CUDA_VISIBLE_DEVICES=3 python -u -W ignore main.py \
--exp_path $WORK_PATH/Eval_DGP_basic_3_1207 \
--root_dir data/others \
--list_file data/others/list_dgp_2.txt \
--seed 2 \
--dgp_mode inpainting \
--update_G \
--update_embed \
